...
import blogThumb from '/images/blog2.png';
import blogThumb2 from '/images/blog4.png';
...
const Blog = () => {
  return (
    <section className=' pt-[35px] bg-[url(/images/blog3_bg.png)] bg-no-repeat bg-center bg-cover py-28'>
      <div className='Container'>
        <div className='text-center'>
          <h5 className='font-FiraSans font-medium text-sm sm:text-base text-PrimaryColor-0 uppercase mb-3'>
            LATEST BLOG
          </h5>
          <h1 className='font-FiraSans font-semibold text-gray-900 inline-block text-[16px] leading-[26px] sm:text-[25px] sm:leading-[35px] md:text-[30px] md:leading-[40px] lg:text-[34px] lg:leading-[44px] xl:text-[40px] xl:leading-[50px] 2xl:text-[42px] 2xl:leading-[52px] relative pb-4'>
            Read Our Latest Insights from the <span className="text-PrimaryColor2-0">Latest Blog Articles</span> 
            <img
              src={border}
              draggable='false'

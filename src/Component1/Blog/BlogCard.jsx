  ...
  return (
    <div className='group transition-all duration-500 bg-white rounded-xl border border-BorderColor2-0 overflow-hidden'>
      ...
      <div className='rounded-md px-4 sm:px-5 md:px-9 lg:px-5 xl:px-9 pb-9 pt-[30px] relative z-20 bg-white transition-all duration-500'>
        <div>
          {/* <Link to={blogUrl}> */}
            <button className='font-FiraSans text-left font-medium text-lg sm:text-xl md:text-lg lg:text-base xl:text-xl 2xl:text-[22px] text-PrimaryColor-0 transition-all duration-500  group-hover:text-PrimaryColor-0'>
              {blogTitle}
            </button>
          {/* </Link> */}

...
const WorkData = [
  ...
  //   workNumber: '02',
  //   workIcon: workIcon2,
  //   workTitle: 'Our Values',
  //   workDesc:
  //     'From the very beginning of our existence we were following certain unwritten rules and values. They’ve been indispensable during everyday duties and decision-making.',
  // },
  {
    id: 2,
    // workNumber: '02',
...
const Work = () => {
  return (
    <section className='mx-2 xl:mx-5 mt-[-10px] pt-[40px] rounded-t-[40px] pt-24 pb-[60px] bg-[url(/images/blog3_bg.png)] bg-no-repeat bg-cover bg-center  relative z-10'>
     <div 
      ...
      <div className='Container'>
        <div className='text-center '>
          ...
          <h1 className='font-FiraSans font-semibold font-extrabold text-gray-900 text-[24px] leading-8 sm:text-[36px] sm:leading-[46px] md:text-[40px] md:leading-[58px] lg:text-[40px] lg:leading-[50px] xl:text-[44px] xl:leading-[54px] 2xl:text-[42px] 2xl:leading-[60px] mt-5'>

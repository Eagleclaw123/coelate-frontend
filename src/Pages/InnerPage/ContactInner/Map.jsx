const ImageGrid = () => {
  ...
  const offices = [
    ...
    //   address: "Suite 205, Hiline Complex, Road No. 12, Banjara Hills, Hyderabad-500034",
    //   phone: "+91 40 1234 5678"
    // },
    {
      city: "Hyderabad, India",
      address: "DSL Abacus IT Park, Survey Colony, Industrial Development Area, Uppal, Hyderabad, Telangana 500039",
      phone: "+91 8500545536"
    },
    {
      city: "Dubai, UAE",
    ...
    <section className="py-12 mt-[-85px] 2xl:mt-0 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <h1 className='font-FiraSans font-semibold text-center mb-12 text-gray-900 text-[32px] md:text-[40px] lg:text-[44px] xl:text-[48px] leading-tight relative pb-4'>
          Spaces Built for <span className="text-PrimaryColor2-0">Creativity</span> & Growth
        </h1>
              ...
              <div className="mt-4 bg-white p-6 rounded-xl shadow-md border border-gray-100">
                <div className="flex items-start mb-4">
                  <div className="bg-PrimaryColor-0/10 p-3 rounded-lg mr-4">
                    <svg className="w-6 h-6 text-PrimaryColor-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-1">{offices[index].city}</h3>
                ...
                <div className="flex items-center mt-4">
                  ...
                  <a href={`tel:${offices[index].phone.replace(/ /g, '')}`} className="text-gray-700 hover:text-PrimaryColor2-0 transition-colors">
                    {offices[index].phone}
                  </a>
                </div>
              </div>

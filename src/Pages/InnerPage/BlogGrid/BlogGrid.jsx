...
const BlogGrid = () => {
  const backgroundImage = '/images/ser.jpg';
  return (
    <>
    <BreadCrumb
       breadCrumbTitle={'Blog'} // Add a title if needed
       breadCrumbSubtitle={<>From Savings to Sustainability: Coelate Powers Smarter Procurement   <br/> with SAP Ariba Transform Procurement into a Strategic Growth Engine</>}
       breadCrumbIcon={<FaArrowRightLong />}
       breadCrumbIcon2={<FaArrowRightLong />}
       url={'/services'} // Update with the correct URL
       breadCrumbLink={''}
